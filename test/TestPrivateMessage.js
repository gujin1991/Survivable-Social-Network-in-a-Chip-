...
suite('SSNoC Unit Test - Private Message', function () {
    ...
    test('Test update private user name', function(done) {
        testMsgPri.updateUserName(tester1, "Jin");
        testMsgPri.updateUserName("Jin", tester1);
        done();
    });

    test('Test delete private msg', function(done) {
        testMsgPri.deleteByUsernamePrivate("Noexist");
        done();
    })
});